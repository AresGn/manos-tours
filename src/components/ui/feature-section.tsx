...
export function FeatureSteps({
  ...
  return (
    <div
      className={cn("p-8 md:p-12 text-white", className)}
      style={{
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {/* Barre de progression pour l'élément actuel */}
                  {index === currentFeature && (
                    ...
                    >
                      <Image
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            parent.style.background = 'linear-gradient(135deg, #1e40af 0%, #3b82f6 50%, #60a5fa 100%)';
                          }
                        }}
                      />
